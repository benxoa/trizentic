...
const socials = [
  { name: "Instagram", href: "#", icon: <FaInstagram size={32} className="mx-auto mb-2 text-foreground" /> },
  { name: "LinkedIn", href: "#", icon: <FaLinkedin size={32} className="mx-auto mb-2 text-foreground" /> },
  { name: "X (Twitter)", href: "#", icon: <FaTwitter size={32} className="mx-auto mb-2 text-foreground" /> },
  { name: "Facebook", href: "#", icon: <FaFacebook size={32} className="mx-auto mb-2 text-foreground" /> },
...
//   { name: "YouTube", href: "#", icon: <FaYoutube size={32} className="mx-auto mb-2 text-foreground" /> }, 
  { name: "TikTok", href: "#", icon: <FaTiktok size={32} className="mx-auto mb-2 text-foreground" /> },
...
//   { name: "Behance", href: "#", icon: <FaBehance size={32} className="mx-auto mb-2 text-foreground" /> }, 
  { name: "WhatsApp", href: "#", icon: <FaWhatsapp size={32} className="mx-auto mb-2 text-foreground" /> },
];
